...
public static class ExportHelperExamples
{
    public static void Run()
    {
        ...
        try
        {
            ...
            var exportHelper1 = new TableExportHelper();
            ...
            Console.WriteLine("\n2. 导出 JSON 数据到 Excel:");
            var exportHelper2 = new TableExportHelper();
            ...
            // 示例 3: 导出到 CSV
            Console.WriteLine("\n3. 导出到 CSV:");
            var exportHelper3 = new TableExportHelper();
            ...
            // 示例 4: 多工作表导出
            Console.WriteLine("\n4. 多工作表导出:");
            var exportHelper4 = new TableExportHelper();
            ...
            // 示例 5: 使用对象列表导出
            Console.WriteLine("\n5. 使用对象列表导出:");
            var exportHelper5 = new TableExportHelper();
            var users = new[]
            {
